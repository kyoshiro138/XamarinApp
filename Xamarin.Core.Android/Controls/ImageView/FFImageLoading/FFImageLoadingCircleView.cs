...
{
    public class FFImageLoadingCircleView : FFImageLoadingView, ICircleImageView
    {
        ...
        private bool _borderOverlay = false;
        ...
        protected FFImageLoadingCircleView(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        public FFImageLoadingCircleView(Context context)
            : base(context)
        {
        }

        public FFImageLoadingCircleView(Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
        }
        ...
        public override void SetImageResource(int resId)
        {
            ...
            _bitmap = GetBitmapFromDrawable(Resources.GetDrawable(resId));
            Setup();
        }
